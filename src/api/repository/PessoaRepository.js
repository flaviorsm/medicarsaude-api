...
var PessoaRepository = /** @class */ (function () {
    ...
    PessoaRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Pessoa_model_1.PessoaModel.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    PessoaRepository.prototype.create = function (entity, session) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Pessoa_model_1.PessoaModel.create([entity], { session: session })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
